      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Envío a domicilio para personas naturales</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Envíos a domicilio para empresas</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Envíos programados para empresas</a></li>
            </ul>
          </div>
