<div id="registerFormComercios">                        
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group row">
            <label for="comNombre" class="col-md-4 col-form-label text-md-right">{{ __('Nombre del Comercio') }}</label>
        ...
        <div class="form-group row">
            <label for="comCuit" class="col-md-4 col-form-label text-md-right">{{ __('CUIT del Comercio') }}</label>
